...
const do_request=require("./do_request.js");
...
module.exports = (id, safe = true) =>
	do_request(`https://www.youtube.com/watch?v=${id}`).then(data => {
			...
			return do_request('https://youtube.com' + window.ytplayer.config.assets.js)
			//	.text()
		})
